...
title: "javax.mail"
date: 2017-11-02
description: "简单邮件发送javax.mail.jar"
tag: 工具
---   
...
public class EmailUtil {
    ...
    public static String myEmailAccount = "godisjohnny@163.com";
    public static String myEmailPassword = "a123456789";//授权码
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "674005274@qq.com";
	...
	public void SendEmail(String content) throws Exception{
	 ...
	 public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String content) throws Exception {
	        ...
	        message.setFrom(new InternetAddress(sendMail, "Johnny同学", "UTF-8"));

	        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
	        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "黄山童鞋", "UTF-8"));

	        // 4. Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）
	        message.setSubject("来一个亲切的问候~", "UTF-8");
